...
$cta_link = stilco_get_link_data( 'home_b2b_cta_text', 'home_b2b_cta_url', 'Skontaktuj się z nami i poznaj ofertę dla firm', '/kontakt?context=b2b#formularz-b2b', $page_id );
?>
	...
	<div class="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
		...
		<div class="grid grid-cols-2 gap-4 animate-slide-right delay-200">
			...
			<div class="bg-white rounded-3xl p-8 border border-white/50 shadow-sm text-center flex flex-col items-center justify-center">
				...
				<span class="text-sm text-gray-500 font-medium tracking-wide uppercase"><?php echo esc_html( stilco_get_page_field( 'home_b2b_stat_2_label', 'Dostawa w całej Polsce', $page_id ) ); ?></span>
			</div>
		</div>
	</div>
</section>
