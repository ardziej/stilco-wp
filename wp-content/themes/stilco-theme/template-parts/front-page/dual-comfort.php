	...
	<div class="max-w-7xl mx-auto px-6">
		<div class="flex flex-col lg:flex-row items-center gap-16">
			<div class="w-full lg:w-1/2 animate-slide-left">
				...
				<h2 class="text-3xl md:text-5xl font-display font-bold mb-6 text-stilco-dark"><?php echo esc_html( stilco_get_page_field( 'home_dual_title', 'Dopasowany do Twoich potrzeb.', $page_id ) ); ?></h2>
			...
			<div class="w-full lg:w-1/2 animate-slide-right delay-200">
				<div class="relative rounded-3xl overflow-hidden aspect-[3/2] shadow-2xl">
