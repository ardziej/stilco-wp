...
<section class="bg-stilco-secondary/20 py-16 text-center border-t border-stilco-secondary/30">
	<div class="max-w-3xl mx-auto px-6">
		...
		<p class="text-gray-600 mb-8 max-w-lg mx-auto"><?php echo esc_html( stilco_get_page_field( 'contact_faq_lead', 'Sprawdź nasze FAQ, w którym odpowiadamy wprost na najczęstsze pytania dotyczące materaca, dostawy i testu 100 nocy.', $page_id ) ); ?></p>
