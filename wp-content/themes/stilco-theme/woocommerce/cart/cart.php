            ...
            <div class="bg-white rounded-3xl shadow-sm border border-gray-100 p-8 sticky top-32">
                ...
                <div class="mt-8 pt-6 border-t border-gray-100 space-y-4">
                    <div class="flex items-start">
                        ...
                        <p class="text-xs text-gray-500 font-sans leading-relaxed">Pamiętaj, Twoje zamówienie objęte jest gwarancją 5 lat oraz 100 nocy testowych. Możesz zwrócić materac, jeśli nie spełni Twoich oczekiwań.</p>
                    </div>
                    <div class="flex items-start">
